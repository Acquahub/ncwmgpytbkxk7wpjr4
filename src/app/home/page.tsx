...
function Home() {
    const titleFont = fonts['Metropolis_ExtraBold'];
const bodyFontFamily = fonts['Metropolis_Regular_(1)'];
const title2FontFamily = fonts['Metropolis_ExtraBold'];
const title3FontFamily = fonts['Metropolis_ExtraBold'];
